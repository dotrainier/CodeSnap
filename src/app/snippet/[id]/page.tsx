...
export default async function SnippetPage({
  ...
  const readTimeLabel =
    readTimeSec < 60 ? `${readTimeSec}s` : `${Math.round(readTimeSec / 60)}m ${readTimeSec % 60}s`;
      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 py-5 sm:py-6 lg:py-8 max-w-6xl'>
        <Link
          ...
          className={cn(
            ...
            '-ml-2 mb-4 gap-1.5 text-muted-foreground hover:text-foreground',
          )}
        >
                ...
                <div className='flex items-center gap-3'>
                  <span
                    className={cn(
                      ...
                      getLangColor(snippet.language, true),
                    )}
                  >
                    {snippet.language}
                  </span>
